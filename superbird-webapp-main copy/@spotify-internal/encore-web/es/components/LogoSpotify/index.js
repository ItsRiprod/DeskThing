...
var _excluded = ["condensed", "color", "semanticColor", "useBrandColor", "label"];
import React from 'react';
import { Svg } from "./Svg";
export var LogoSpotify = function LogoSpotify(_ref) {
  var condensed = _ref.condensed,
      color = _ref.color,
      _ref$semanticColor = _ref.semanticColor,
      semanticColor = _ref$semanticColor === void 0 ? 'decorativeBase' : _ref$semanticColor,
      useBrandColor = _ref.useBrandColor,
      _ref$label = _ref.label,
      label = _ref$label === void 0 ? 'Spotify' : _ref$label,
      props = _objectWithoutProperties(_ref, _excluded);

  /**
   * SVG paths need to be optimized. To optimize, use SVGO (command line) or SVGOMG (online).
   *
   *   Get the SVG source:
   *   - In Figma, right-click and choose "Copy/Paste as" > "Copy as SVG"
   *
   *   Optimize with SVGO:
   *   - Install globally: `yarn add global svgo`
   *   - Paste source into a new file `local.svg` in root, but don't commit it
   *   - Run `svgo logo.svg -o logo-optimized.svg`
   *
   *   Optimize with SVGOMG:
   *   - Paste source into https://jakearchibald.github.io/svgomg/ using default options
   *   - Download resulting SVG
   *
   *   Update the component:
   *   - Paste only the path from the optimized SVG and into this component
   *   - Make sure the path doesn't include `fill`, which most optimizers won't strip out!
   */
  return /*#__PURE__*/React.createElement(Svg, Object.assign({
    role: "img",
    color: color,
    viewBox: condensed ? '0 0 26 24' : '0 0 78 24',
    semanticColor: semanticColor,
    useBrandColor: useBrandColor,
    "aria-label": label,
    "aria-hidden": label === ''
  }, props), /*#__PURE__*/React.createElement("title", null, label), /*#__PURE__*/React.createElement("path", {
...
/**
* **LogoSpotify** ![Status: Production](https://img.shields.io/badge/PRODUCTION-%2357B560|height=14)
*
* [GitHub](https://ghe.spotify.net/encore/web/tree/master/src/core/components/LogoSpotify) | [Storybook](https://encore-web.spotify.net/?path=/docs/components-logo-logospotify--default) | [Encore](https://encore.spotify.net/web/components/logo?format=figma-figma#main-logos) | [Figma](https://www.figma.com/file/bnQXqGkLeiTlbk8JXGDcsX/Encore-Web---Light-Theme-Toolkit?node-id=391:1232) |
*
* Renders the full logo for the Spotify masterbrand
*
* @example
* () => <LogoSpotify height="24" />;
*
*/