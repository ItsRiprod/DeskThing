import { Key, EventMode, Action, ButtonMappingStructure, MappingProfile } from '@deskthing/types'
...
export const defaultButtonMappingStructure: ButtonMappingStructure = {
  Wheel1: {
    [EventMode.KeyDown]: {
      enabled: true,
      id: 'pref',
...
export const defaultMappingProfile: MappingProfile = {
  mapping: defaultButtonMappingStructure,
  keys: keys,
  actions: actions,
  profileId: 'default-mapping'
}
