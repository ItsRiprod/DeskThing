...
>
    <g>
        <path
            ...
            fill="${highlighted.includes('1') ? highlightColor : 'currentColor'}"
            stroke="${highlighted.includes('1') ? highlightColor : 'currentColor'}"
        />
        <path
            ...
            stroke-width="${strokeWidth}"
            fill="${highlighted.includes('2') ? highlightColor : 'currentColor'}"
            stroke="${highlighted.includes('2') ? highlightColor : 'currentColor'}"
        />
        <path
            ...
            stroke-width="${strokeWidth}"
            fill="${highlighted.includes('3') ? highlightColor : 'currentColor'}"
            stroke="${highlighted.includes('3') ? highlightColor : 'currentColor'}"
        />
        <path
            ...
            stroke-width="${strokeWidth}"
            fill="${highlighted.includes('4') ? highlightColor : 'currentColor'}"
            stroke="${highlighted.includes('4') ? highlightColor : 'currentColor'}"
        />
        <path
