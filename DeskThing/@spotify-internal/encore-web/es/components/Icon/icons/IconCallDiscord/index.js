...
export function IconCallDiscord(props) {
...
export function Experimental__IconMic(props) {
  return /*#__PURE__*/React.createElement(IconCallDiscord, props);
}