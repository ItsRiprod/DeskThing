import { color as colorTokens } from '@spotify-internal/encore-foundation'; // Helper for any prop that behaves like `as` from styled-components (ie `component` in Button)
